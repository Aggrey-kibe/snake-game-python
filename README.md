...
## Overview
This project is a fully functional Snake Game implemented in Python using the Pygame framework. It demonstrates real-time game loops, event handling, collision detection, and state management. The project emphasizes clean structure, readability, and correct game logic — making it suitable for portfolio or technical review.
...
## Project Structure
The main Python script `snake_game.py` contains the full game logic, including:
- Initialization of Pygame and screen setup
...
- Visual enhancements (animations or sprites)
